...
export const findArticlePostAPI = async (article: IArticles) =>{
    try{  
        const response = (await instance().post('/articles/find', article))
        return response.data
    }catch(error){
        console.log(error)
        return error
...
export const updateArticleAPI = async (article: IArticles) =>{
    try{  
        const response = (await instance().post('/articles/update', article))
        return response.data
    }catch(error){
        console.log(error)
        return error
