...
-- insert into users (user_id, username, password, name, phone) values (3, 'scurbishley2', 'rZ4${k.YiMf}3I7I', 'Sansone Curbishley', '636-360-1862');
-- insert into users (user_id, username, password, name, phone) values (4, 'ifydo3', 'lH8?yz/jIw.!P', 'Iggie Fydo', '519-984-2323');
-- insert into users (user_id, username, password, name, phone) values (5, 'ablowers4', 'fJ5|RgdI', 'Abran Blowers', '705-815-8897');
